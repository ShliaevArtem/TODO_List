...
function todos() {
  ...
  for (prop in data) {
    for (i = 0; i < data[prop].length; i++) {
      descritpion = document.querySelector('.todo-form__description'); 
      var val = descritpion.value;
      text = document.createElement('p');
      text.innerText = descritpion;
...
document.querySelector('.todo-form').addEventListener('submit', function(e){
  ...
  description = document.querySelector('.todo-form__description');
  val = input.value.trim();
  val_desc = description.value;
